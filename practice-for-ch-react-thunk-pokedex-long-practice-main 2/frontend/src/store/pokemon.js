...
import * as PokemonAPIUtils from '../utils/pokemon_api_utils'
...
export const onePokemonDetail = (pokemonId) => async(dispatch) => {
  const response = await PokemonAPIUtils.getAPokemon(pokemonId);
  // const data = res.json();
  dispatch(addOnePokemon(pokemonId));
